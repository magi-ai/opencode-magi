...
OpenCode Magiは、人工知能（AI）ツールの支援を活用した貢献を含め、すべての方からの貢献を歓迎します。私たちは、AIがソフトウェアの改善に役立つ協力なツールになり得ると信じており、プロジェクトにおいて責任ある利用を奨励したいと考えています。
...
AIの使用を開示していない問題やプルリクエストは、レビューなしでクローズされる場合があります。このポリシーに繰り返し違反した場合は、OpenCode Magiへの貢献をブロックされる可能性があります。

## 人間の責任

AIはコードやテキストの生成を支援できますが、貢献に対する最終的な責任は提出者である人間にあります。

- **作業内容の確認:** AIが生成したプルリクエストを提出する前に、コードを十分にレビューし、テストしてください。OpenCode Magiのコーディング規約を満たし、問題に対して正しく対処していることを確認してください。
