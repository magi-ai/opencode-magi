...
Issues and pull requests that do not disclose the use of AI may be closed without review. Those who violate this policy repeatedly may be blocked from contributing to OpenCode Magi.
...
- **Review your work:** Before submitting a pull request generated by AI, you are expected to have thoroughly reviewed and tested the code yourself. Ensure it meets OpenCode Magi's coding standards and correctly addresses the issue.
