...
| `triage.agents[].id`                   | Both    | No                           | `triage-1`, ...                                      | Triage agent key used for output files and session tracking.                                                         |
...
| `triage.creator`                       | Both    | Yes (`triage.automation.pr`) | -                                                    | Agent used to create implementation PRs from accepted issues.                                                        |
| `triage.creator.account`               | Both    | No                           | `triage.account`                                     | GitHub account used to create PRs when different from `triage.account`.                                              |
| `triage.creator.model`                 | Both    | Yes (`triage.automation.pr`) | -                                                    | Full OpenCode model ID used by the PR creator agent.                                                                 |
...
| `triage.creator.author.name`           | Both    | Yes (`triage.automation.pr`) | -                                                    | Git author name used for commits created by the PR creator.                                                          |
| `triage.creator.author.email`          | Both    | Yes (`triage.automation.pr`) | -                                                    | Git author email used for commits created by the PR creator.                                                         |
| `triage.kind.bug.label`                | Both    | No                           | `["bug"]`                                            | Labels that classify an issue as a bug and skip Kind Vote.                                                           |
| `triage.kind.bug.type`                 | Both    | No                           | `["Bug"]`                                            | Issue types for bug classification when GraphQL issue types are available.                                           |
| `triage.kind.feature.label`            | Both    | No                           | `["enhancement"]`                                    | Labels that classify an issue as a feature request and skip Kind Vote.                                               |
| `triage.kind.feature.type`             | Both    | No                           | `["Feature"]`                                        | Issue types for feature classification when GraphQL issue types are available.                                       |
...
| `triage.automation.pr`                 | Both    | No                           | `false`                                              | Whether accepted issues can create implementation PRs.                                                               |
| `triage.automation.clear`              | Both    | No                           | `["triage"]`                                         | Labels removed after non-ASK triage results. Set `[]` to disable label removal.                                      |
...
| `triage.prompts.kind`                  | Both    | No                           | [md](/docs/prompts/triage/kind.md)                   | Task template override for classifying an issue as a bug, feature, or question.                                      |
| `triage.prompts.bug`                   | Both    | No                           | [md](/docs/prompts/triage/bug.md)                    | Task template override for deciding whether a bug report should be accepted.                                         |
| `triage.prompts.feature`               | Both    | No                           | [md](/docs/prompts/triage/feature.md)                | Task template override for deciding whether a feature request should be accepted.                                    |
| `triage.prompts.action`                | Both    | No                           | [md](/docs/prompts/triage/action.md)                 | Task template override for planning the final triage action.                                                         |
...
| `triage.prompts.createPr`              | Both    | No                           | [md](/docs/prompts/triage/create-pr.md)              | Task template override for creating implementation PRs.                                                              |
