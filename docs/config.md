...
| `triage.agents[].account`              | Both    | Yes                              | -                                                    | GitHub account used by this triage agent, including its `ASK` comments.                                              |
...
| `triage.reporter`                      | Both    | No                               | issue-number selection                               | Triage agent key used for non-`ASK` comments, issue and linked PR closes, and label removal.                         |
| `triage.creator`                       | Both    | Yes (`triage.automation.create`) | -                                                    | Agent used to create implementation PRs from accepted issues.                                                        |
| `triage.creator.account`               | Both    | Yes (`triage.automation.create`) | -                                                    | GitHub account used to create implementation PRs.                                                                    |
...
| `triage.automation.close`              | Both    | No                               | `false`                                              | Whether rejected or duplicate issues are closed after a close decision comment.                                      |
...
| `triage.safety.allowMentionActors`     | Both    | No                               | `[]`                                                 | GitHub logins allowed to trigger reconsideration by mentioning the previous triage comment account.                  |
| `triage.safety.allowMentionRoles`      | Both    | No                               | `["AUTHOR", "OWNER", "MEMBER", "COLLABORATOR"]`      | GitHub author associations allowed to trigger reconsideration by mentioning the previous triage comment account.     |
