...
| `review.output`                        | Both    | No                               | `.magi/runs/pr`                                      | Directory for PR run artifacts such as review context, prompts, raw model output, parsed JSON, posting results, and reports. PR #123 is stored under `<dir>/123/<runId>`. |
