...
| `review.reviewers[].model`             | Both    | Yes                              | -                                                    | Full OpenCode model ID used by the reviewer.                                                                                                                  |
| `review.reviewers[].account`           | Both    | Yes                              | -                                                    | GitHub account used to post reviews and approvals.                                                                                                            |
| `review.reviewers[].options`           | Both    | No                               | -                                                    | OpenCode provider/model options injected for this reviewer.                                                                                                   |
...
| `triage.voters[].model`                | Both    | Yes                              | -                                                    | Full OpenCode model ID used by the triage voter.                                                                                                              |
...
| `triage.voters[].options`              | Both    | No                               | -                                                    | OpenCode provider/model options injected for this triage voter.                                                                                               |
